        ...
        try:
            match __arg:
                ...
                case arg if all(map(lambda i: isinstance(i, Image), arg)):
                    ...
                case _:
                    raise TypeError("Argument should be a string, a list of strings or a list of 'Surfaces' or a list of instances of the 'Image' class")
        except TypeError:
            raise TypeError("Argument should be a string, a list of strings or a list of 'Surfaces' or a list of instances of the 'Image' class")
...
class ImageEditor:
    ...
    @classmethod
    def mult_size(cls, __image: Image, mult_width: int, mult_height: int) -> Image:
        cls.__verify_image(__image)
...
class AnimationEditor:
    ...
    @classmethod
    def mult_size(cls, __animation: Animation, mult_width: int, mult_height: int) -> Animation:
        cls.__verify_animation(__animation)
    ...
    def split_by_size(__image: Image, tile_size: Vec2) -> Animation:
        ...
        for y in range(count.y):
            for x in range(count.x):
                res.append(ImageEditor.cut(__image, x * tile_size.x, y * tile_size.y, tile_size.x, tile_size.y))
